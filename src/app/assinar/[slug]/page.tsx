  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: 420 }}>
        ...
        <p style={{ textAlign: "center", color: "#7A6010", fontSize: 11, letterSpacing: "0.4em", textTransform: "uppercase", marginBottom: 32 }}>
          — AI ORCHESTRATOR —
        </p>
        ...
        <div style={{
          ...
          <p style={{ color: "#7A6010", fontSize: 11, letterSpacing: "0.3em", textTransform: "uppercase", marginBottom: 6 }}>
            {plan.modo}
          </p>
          <p style={{ color: "#FFE082", fontSize: 26, fontWeight: 700, marginBottom: 2 }}>
            {plan.plano}
          </p>
          <p style={{ color: "#D4A017", fontSize: 22, fontWeight: 700, marginBottom: 20 }}>
            {plan.priceLabel}
          </p>
            ...
            <tbody>
              {plan.features.map((f, i) => (
                <tr key={i} style={{ borderBottom: "1px solid rgba(212,160,23,0.1)" }}>
                  <td style={{ padding: "10px 0", color: "#D4A017", width: 24, fontSize: 14 }}>✓</td>
                  <td style={{ padding: "10px 0", color: "#C8CDD8", fontSize: 14 }}>{f}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div style={{ marginBottom: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
            ...
            <p style={{ color: "#C8CDD8", fontSize: 14 }}>Seu WhatsApp para acessar o Kadosh</p>
          </div>
        ...
        >
          {loading ? "Redirecionando..." : `Assinar ${plan.plano} — ${plan.priceLabel}`}
        </button>

        <p style={{ textAlign: "center", fontSize: 12, color: "#3A2C06", marginTop: 16 }}>
