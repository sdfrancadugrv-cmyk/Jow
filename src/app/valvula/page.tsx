...
export default function ValvulaPage() {
  ...
  return (
    <>
      ...
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="white" style={{ flexShrink: 0, animation: "wppPulse 1.8s ease-in-out infinite" }}>
        ...
        <style>{`@keyframes wppPulse{0%,100%{transform:scale(1)}50%{transform:scale(1.18)}}`}</style>
      </a>
      <div style={{ height: 52 }} />
