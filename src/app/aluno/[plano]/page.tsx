...
const ESTRUTURA: Record<string, {
  ...
  "professor-start": {
    ...
    preco: "R$ 97/mês",
    descricao: "Professor particular de IA + 1 língua estrangeira + 1 concurso público.",
    modulos: [
      { icone: "🎓", nome: "Professor Particular", descricao: "Aulas sobre qualquer assunto, a qualquer hora.", disponivel: true },
      { icone: "🌍", nome: "1 Língua Estrangeira", descricao: "Inglês, Espanhol ou outro idioma à sua escolha.", disponivel: true },
  ...
  "professor-pro": {
    ...
    preco: "R$ 197/mês",
    descricao: "Professor particular de IA + 2 línguas estrangeiras + 2 concursos públicos.",
    modulos: [
      { icone: "🎓", nome: "Professor Particular", descricao: "Aulas sobre qualquer assunto, a qualquer hora.", disponivel: true },
      { icone: "🌍", nome: "2 Línguas Estrangeiras", descricao: "Estude dois idiomas simultaneamente.", disponivel: true },
  ...
  "professor-scale": {
    ...
    preco: "R$ 497/mês",
    descricao: "Professor particular de IA com línguas e concursos ilimitados.",
    modulos: [
      { icone: "🎓", nome: "Professor Particular", descricao: "Aulas sobre qualquer assunto, sem limite.", disponivel: true },
      { icone: "🌍", nome: "Línguas Ilimitadas", descricao: "Estude quantos idiomas quiser.", disponivel: true },
